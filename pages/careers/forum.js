...
function Forum() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      // url = 'https://globaltechnologia.com/webAdmin/api/apply_job'
      axios
        .post(
          "https://globaltechnologia.com/webAdmin/public/index.js/api/apply_job",
          formData,
          config
        )
        .then((response) => {
      ...
      // fetch("https://globaltechnologia.com/webAdmin/api/apply_job", requestOptions)
